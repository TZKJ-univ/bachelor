...
# 学習データの読み込み
train_data1_df = pd.read_csv('60tps_ord.csv', header=None)
train_data2_df = pd.read_csv('70tps_ord.csv', header=None)
train_data3_df = pd.read_csv('80tps_ord.csv', header=None)
train_data4_df = pd.read_csv('90tps_ord.csv', header=None)
train_data5_df = pd.read_csv('100tps_ord.csv', header=None)
train_data6_df = pd.read_csv('110tps_ord.csv', header=None)
train_data7_df = pd.read_csv('120tps_ord.csv', header=None)
train_data8_df = pd.read_csv('130tps_ord.csv', header=None)
train_data9_df = pd.read_csv('140tps_ord.csv', header=None)
train_data10_df = pd.read_csv('150tps_ord.csv', header=None)
train_data11_df = pd.read_csv('160tps_ord.csv', header=None)
train_data12_df = pd.read_csv('170tps_ord.csv', header=None)
train_data13_df = pd.read_csv('180tps_ord.csv', header=None)
train_data14_df = pd.read_csv('190tps_ord.csv', header=None)
train_data15_df = pd.read_csv('200tps_ord.csv', header=None)
