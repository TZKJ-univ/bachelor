...
# 学習データ1の読み込み
train_data1_df = pd.read_csv('200tps_non.csv', header=None)

# 学習データ2の読み込み
train_data2_df = pd.read_csv('140tps_non.csv', header=None)

# 学習データ3の読み込み
train_data3_df = pd.read_csv('100tps_non.csv', header=None)

# 学習データ4の読み込み
train_data4_df = pd.read_csv('80tps_non.csv', header=None)

train_data5_df = pd.read_csv('60tps_non.csv', header=None)

train_data6_df = pd.read_csv('180tps_non.csv', header=None)

train_data7_df = pd.read_csv('160tps_non.csv', header=None)
...
# テストデータの読み込み
test_data_df = pd.read_csv('120tps_non.csv', header=None)
